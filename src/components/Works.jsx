      ...
      <div className="app__work-filter">
        {["All", "Beginner", "Intermediate", "Advanced"].map((item, index) => (
          <button
            ...
            className={`${
              activeFilter === item ? "" : "hover:text-white/50"
            } relative rounded-full px-3 py-1.5 text-[16px] font-medium text-white outline-2 outline-sky-400 focus-visible:outline`}
          >
            {activeFilter === item && (
              <motion.div
            ...
            <span className="relative z-10 mox-blend-exclusion">{item}</span>
          </button>
        ))}
      </div>
